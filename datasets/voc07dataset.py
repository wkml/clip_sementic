...
class Voc07Dataset(data.Dataset):
    def __init__(self, img_dir='./data/VOCdevkit/VOC2007/JPEGImages', anno_path='./data/VOCdevkit/VOC2007/Main/trainval.txt', input_transform=None, labels_path='./data/VOCdevkit/VOC2007/Annotations'):
        self.img_names  = []
