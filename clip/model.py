...
class ModifiedResNet(nn.Module):
    ...
    def __init__(self, layers, output_dim, heads, input_resolution=224, width=64, attn=True):
        super().__init__()
        self.attn = attn
...
def build_model(state_dict: dict, args):
    ...
    model = CLIP(
        ...
        context_length, vocab_size, transformer_width, transformer_heads, transformer_layers, args.use_attn
    )
